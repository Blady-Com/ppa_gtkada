...
begin
   ...
   Set_Invisible_Char (Window1.Entry1, UTF8_Get_Char ("●"));
   ...
   Gtk_New (Window1.Checkbutton1, -("Entier / Décimal"));

   Set_Size_Request (Window1.Checkbutton1, 147, 34);
   Put (Window1.Fixed1, Window1.Checkbutton1, 110, 140);
   Gtk_New (hscale1_Adj, 0.0, 0.0, 10.0, 1.0, 2.0, 1.0);
   Gtk_New_Hscale (Window1.hscale1, hscale1_Adj);
   Set_Digits (Window1.Hscale1, 0);
   Set_Value_Pos (Window1.Hscale1, Pos_Left);

   Set_Size_Request (Window1.Hscale1, 100, 36);
   Put (Window1.Fixed1, Window1.Hscale1, 110, 170);
   Gtk_New (Window1.Label2, -("Décimale(s)"));

   Set_Size_Request (Window1.Label2, 100, 35);
   Put (Window1.Fixed1, Window1.Label2, 210, 170);
   Gtk_New (Window1.Label3, -("Résultat"));

   Set_Size_Request (Window1.Label3, 230, 30);
   Put (Window1.Fixed1, Window1.Label3, 110, 30);
